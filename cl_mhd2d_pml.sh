...
#
echo "compiling mhd2d_pml.f90..."
ifort -c ${debug_opts} ${src_dir}/mhd2d_pml.f90
#mv mhd2d_pml.o ${obj_dir}
#
...
ifort ${f90flags} ${obj_dir}/mhd2d_va_cond.o ${obj_dir}/mhd2d_constants.o ${obj_dir}/mhd2d_grid.o ${obj_dir}/mhd2d_pml.o -o ${exec_name} ${lnk_lapack} ${debug_opts}
